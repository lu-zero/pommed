...
static int
evdev_is_2013mac(unsigned short *id)
{
  unsigned short product = id[ID_PRODUCT];
  ...
  if ((product == USB_PRODUCT_ID_MAC2013_ANSI)
      || (product == USB_PRODUCT_ID_MAC2013_ISO)
      || (product == USB_PRODUCT_ID_MAC2013_JIS))
    {
      logdebug(" -> Mac2013 USB assembly\n");
